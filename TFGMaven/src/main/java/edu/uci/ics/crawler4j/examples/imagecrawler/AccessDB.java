...
public class AccessDB {
	...
	public int Guardar(String title, String subject, String description, String source, String format){
		...
		String SSQL = "INSERT INTO image (title, subject, description, source, languaje, relation, coverage, creator, publisher, contributor, rights, date, type, format, identifier) "
		            + "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
